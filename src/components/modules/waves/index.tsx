...
export const Waves = ({ className }: WavesPropTypes) => (
  <S.WaveArea className={className}>
    {[0, 1, 0, 1].map((variant, index) => (
      <S.WaveContainer delay={0} key={index}>
...
export const Wave = ({ className, variant }: WavePropsType) => (
  <S.SVG
    className={className}
